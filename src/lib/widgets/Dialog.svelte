<script lang="ts">
    ...
    let {isOpen = false, children, onrequestclose}: {isOpen: boolean; children: Snippet; onrequestclose?: () => void} = $props();
...
<dialog bind:this={dialog} class:closing={!isOpen} onclose={handleClose} onanimationend={handleAnimationEnd}>
    {#if children}
        {@render children()}
    {/if}
</dialog>
